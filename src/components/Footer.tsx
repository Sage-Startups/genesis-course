        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-sm">
              Transform any topic into comprehensive, professional courses with our advanced AI-powered platform.
            </p>
        ...
        <div className="pt-8 border-t border-primary-foreground/20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-primary-foreground/80 text-sm">
              © 2024 CourseAI. All rights reserved.
            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    key={social.name}
                    href={social.href}
                    className="p-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200"
